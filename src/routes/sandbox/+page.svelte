<div class="absolute inset-0 overflow-hidden">
    <div class="helv flex flex-col h-full bg-[#F7DEC8] w-full relative sm:hidden">
        ...
        <div class="z-10 h-2/4 flex flex-col items-center justify-center">
            <div class="flex flex-col w-fit text-3xl tracking-tight text-black text-opacity-60 pt-16">
                ...
                <div class=""><span class="tracking-tighter text-black text-opacity-75 font-bold">Shomegie Ikerodah </span>& I'm a</div>
