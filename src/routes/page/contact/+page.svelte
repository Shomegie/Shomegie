<div class="w-full pt-6">
    <div class="flex flex-col w-5/6 sm:w-4/6 mx-auto ">
        ...
        <div class="myForm w-full">
            <form class="flex flex-col w-full space-y-6" action="https://formsubmit.co/null" method="POST">
                <div class="flex w-full space-x-2">
                    <input class="focus:outline-none focus:border-stone-400 w-1/2 border-2 rounded-lg border-stone-600 pl-2 py-1" placeholder="name" type="text" name="name" required>
                ...
                <input class="focus:outline-none focus:border-stone-400 w-full border-2 rounded-lg border-stone-600 pl-2 py-1"  placeholder="subject" type="text" required>
                <textarea placeholder="your message" class="focus:outline-none focus:border-stone-400 border-2 rounded pt-1 pl-2 border-stone-600"  rows="6" required></textarea>
